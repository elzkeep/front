    ...
    <y-tr v-for="(item, index) in data.items">
      <y-td>
        <y-table>
          ...
          <y-tr>
            ...
            <y-td>
              <el-select size="small" v-model="data.items[index].value2" placeholder="" style="width: 150px">
                <el-option v-for="item in data.gass" :key="item.id" :label="item.name" :value="item.id" />
              </el-select>
          ...
          <y-tr>
            <y-th>정격출력</y-th>
            <y-td> <el-input v-model="data.items[index].value4" style="width: 50px" /> kW </y-td>
            <y-th>가스소비량</y-th>
            <y-td> <el-input v-model="data.items[index].value5" style="width: 50px" /> kW </y-td>
          </y-tr>
          <y-tr>
            <y-th>형태</y-th>
            <y-td>
            ...
            <y-th>가스입력범위</y-th>
            <y-td> 최소 <el-input v-model="data.items[index].value6" style="width: 50px" /> pPa ~ 최대 <el-input v-model="data.items[index].value7" style="width: 50px" /> kPa </y-td>
          </y-tr>
          <y-tr>
            <y-th>정격전압</y-th>
            <y-td> <el-input v-model="data.items[index].value8" style="width: 50px" /> V </y-td>
            <y-th>주파수</y-th>
            <y-td> <el-input v-model="data.items[index].value9" style="width: 50px" /> Hz </y-td>
          </y-tr>
          <y-tr>
            <y-th>발전효율</y-th>
            <y-td> <el-input v-model="data.items[index].value10" style="width: 50px" /> % </y-td>
            <y-th>열효율</y-th>
            <y-td> <el-input v-model="data.items[index].value11" style="width: 50px" /> % </y-td>
          </y-tr>
          <y-tr>
            <y-th>계통연계</y-th>
            <y-td>
          ...
          <y-tr>
            ...
            <y-th>배기통길이</y-th>
            <y-td> <el-input v-model="data.items[index].value15" style="width: 50px" /> m </y-td>
          </y-tr>
          <y-tr>
            <y-th>제조사</y-th>
            <y-td>
          ...
          <y-tr>
            <y-th>제작년월</y-th>
            <y-td colspan="3"> <el-input v-model="data.items[index].value18" style="width: 50px" /> 년 <el-input v-model="data.items[index].value19" style="width: 30px" /> 월 </y-td>
          </y-tr>
        </y-table>
      </y-td>
