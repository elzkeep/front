      ...
      <y-td>
        <y-table>
          <y-tr>
            ...
            <y-td colspan="3">
              <el-input v-model="data.items[index].value11" style="width:50px;" /> V
            </y-td>
          </y-tr>
          <y-tr>
            <y-th>정격용량</y-th>
            <y-td colspan="3">
              <el-input v-model="data.items[index].value12" style="width:50px;" /> kW
            </y-td>
          </y-tr>
          <y-tr>
            <y-th>형태</y-th>
          ...
          <y-tr>
            <y-th>제작년월</y-th>
            <y-td colspan="3">
              <el-input v-model="data.items[index].value15" style="width:50px;" /> 년 <el-input v-model="data.items[index].value16" style="width:30px;" /> 월
            </y-td>
          </y-tr>
        </y-table>
      </y-td>
      <y-td>
        <y-table>
          <y-tr>
            ...
            <y-td colspan="3">
              <el-input v-model="data.items[index].value17" style="width:50px;" /> kW
            </y-td>
          </y-tr>
          <y-tr>
            <y-th>종류</y-th>
