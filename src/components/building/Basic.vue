<template>
  ...
  <y-table>
    ...
    <y-tr>
      <y-th>수전용량</y-th>
      <y-td>
        <el-input v-model="data.item.value2" style="width:100px;" /> kW              
      </y-td>
    </y-tr>
    <y-tr>
      <y-th>수전형태</y-th>
  ...
  <y-table style="margin-top:10px;">
    <y-tr>
      ...
      <y-td>
        <el-input v-model="data.item.value10" />        
  ...
  <y-table style="margin-top:10px;">
    ...
    <y-tr v-for="(item, index) in data.transs">
      ...
      <y-td>
        <el-input v-model="data.transs[index].value3" style="width:50px;" /> kVA              
      </y-td>
      <y-td>
        <el-input v-model="data.transs[index].value4" style="width:50px;" /> %         
      </y-td>
      <y-td>
        <el-input v-model="data.transs[index].value5" style="width:50px;" /> V          
      </y-td>
      <y-td>
      ...
      <y-td>
        <el-input v-model="data.transs[index].value8" style="width:50px;" /> 년
        <el-input v-model="data.transs[index].value9" style="width:30px;" /> 월        
      </y-td>
      <y-td style="text-align:center;">
        <el-button v-if="index == 0" size="small" class="filter-item" type="primary" @click="clickAddTrans"><el-icon><Plus /></el-icon></el-button>
        <el-button v-if="index != 0" size="small" class="filter-item" type="danger" @click="clickDeleteTrans(index)"><el-icon><Close /></el-icon></el-button>
      </y-td>            
    </y-tr>
  </y-table>
  ...
  <y-table style="margin-top:10px;" v-if="data.item.value3 == 2">
    ...
    <y-tr v-for="(item, index) in data.highs">
      ...
      <y-td>
        <el-input v-model="data.highs[index].value3" style="width:50px;" /> kA              
      </y-td>
      <y-td>
        <el-input v-model="data.highs[index].value4" style="width:50px;" /> kV          
      </y-td>
      <y-td>
        <el-input v-model="data.highs[index].value5" style="width:50px;" /> A          
      </y-td>
      <y-td>
      ...
      <y-td>
        <el-input v-model="data.highs[index].value8" style="width:50px;" /> 년
        <el-input v-model="data.highs[index].value9" style="width:30px;" /> 월        
      </y-td>
      ...
      <y-td>
        ...
        <y-table>
          ...
          <y-tr v-for="(item2, index2) in data.highs[index].content">
            ...
            <y-td style="text-align:center;">
              <el-button v-if="index2 == 0" size="small" class="filter-item" type="primary" @click="clickAddRelay(index)"><el-icon><Plus /></el-icon></el-button>
              <el-button v-if="index2 != 0" size="small" class="filter-item" type="danger" @click="clickDeleteRelay(index, index2)"><el-icon><Close /></el-icon></el-button>
            </y-td>            
          </y-tr>
        </y-table>
      ...
      <y-td style="text-align:center;">
        <el-button v-if="index == 0" size="small" class="filter-item" type="primary" @click="clickAddHigh"><el-icon><Plus /></el-icon></el-button>
        <el-button v-if="index != 0" size="small" class="filter-item" type="danger" @click="clickDeleteHigh(index)"><el-icon><Close /></el-icon></el-button>
      </y-td>            
    </y-tr>
  </y-table>
