  ...
  <el-table :data="data.items" border :height="height(170)" @row-click="clickUpdate"  ref="listRef" @selection-change="changeList">
    ...
    <el-table-column label="구분" width="60" align="center">
      <template #default="scope">
        <span v-if="scope.row.category == 1">프로그램</span>
        <span v-if="scope.row.category == 2">일반이용</span>
      </template>
    </el-table-column>
        ...
        <y-tr>
          ...
          <y-td>
            <el-radio-group v-model="data.item.category">
              <el-radio-button size="small" value="1">프로그램</el-radio-button>
              <el-radio-button size="small" value="2">일반이용</el-radio-button>
            </el-radio-group>
          </y-td>
        </y-tr>
        <y-tr>
